...
sorted_BrownMarron <- sort(BrownMarron)

plot(sorted_BrownMarron, type = "l", xlab = "Index", ylab = "Value",

     main = "Line Plot of BrownMarron Numerical Vector")
